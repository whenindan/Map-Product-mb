...
function showGraph(location) {
    const historicalDataPath = `./data/Sensory_Measurements/Soc_Trang/JSON_proc/compiled_historical_data_st.json`;
...
markerFromData('./data/Sensory_Measurements/Tra_Vinh/JSON_proc/travinh-locations.json', 'Tra Vinh');
markerFromData('./data/Sensory_Measurements/Soc_Trang/JSON_proc/soctrang-locations.json', 'Soc Trang');
